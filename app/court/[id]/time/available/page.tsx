    ...
    <div className="p-10 bg-white flex flex-col gap-6 font-sans ">
      <div>
        <div className="flex flex-col md:flex-row gap-5 items-center">
          ...
          <h1 className="text-1xl font-semibold font-sans">Available</h1>
        </div>
        ...
        <div className="flex justify-center item-center mt-5">
          ...
          >
            ...
            <div className="relative w-65 h-100 rounded-3xl text-gray-500 text-sm shadow-xl overflow-hidden">
              ...
              <div className="h-[50%] bg-gray-500/10 backdrop-blur-xs shadow-[-10_-0px_10px_-15px_rgba(0,0,0,0.1)] ">
                <div>
                  <p className=" text-white font-bold text-md mt-4 mx-4 h-[20%]">
                    COURT 1
                  </p>
                  <div className="flex-col mx-4 h-[80%] mt-4 ">
                    <div className=" h-19.5">
                      ...
                      <div className="flex gap-1 mt-4">
                        <div className="flex bg-gray-800/20 shadow-xl h-6 w-14 rounded-xl text-xs justify-center text-gray-100 mt-1 gap-1 p-1">
                          <p className="font bold ">₱</p>
                          <p className="font-thin">200</p>
                        </div>
                        <p className="text-xs mt-2 text-gray-100">per hour</p>
                      </div>
                    </div>
                    <div className="bg-white border-1 h-8  rounded-2xl shadow-xl mt-6">
